package com.ademozalp.newsappjava.ui.home;
...
import com.ademozalp.newsappjava.databinding.FragmentHomeBinding;
...
public class HomeFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Call<ResponseModel> call = apiService.getTopNews("tr", apiKey.getKey());
