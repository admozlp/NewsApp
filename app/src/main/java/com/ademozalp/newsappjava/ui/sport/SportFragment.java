package com.ademozalp.newsappjava.ui.sport;
...
import com.ademozalp.newsappjava.databinding.FragmentSportBinding;
...
public class SportFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Call<ResponseModel> call = apiService.getLatestNews("tr", "sport", apiKey.getKey());
